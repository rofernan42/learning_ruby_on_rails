...
/* WEBPACK VAR INJECTION */(function($) {// Load all the channels within this directory and all subdirectories.
...
$(function () {
  ...
  return $("a[data-remote]").on("ajax:beforeSend", function (event) {
    return console.log("Event ".concat(event, " is going to be sent"));
  });
});
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery3'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'popper'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-sprockets'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/******/ });
//# sourceMappingURL=application-bdc11cd327f5347bd1ad.js.map